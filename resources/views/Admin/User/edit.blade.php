            ...
            <div class="card-body">
                ...
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <div class="input-group">
                                <input type="password" name="password"  class="form-control"  placeholder="{{__('admin.users_form_password_label')}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <div class="input-group">
                                <input type="password" name="password_confirmation"  class="form-control"  placeholder="{{__('admin.users_form_password_label')}}">
                            </div>
                        </div>
                    </div>
